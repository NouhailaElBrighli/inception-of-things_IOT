...
def helm_configuration():
    colpr("g", "Adding GitLab Helm repository")
    run("helm repo add gitlab https://charts.gitlab.io/")
    run("helm repo update")

    colpr("g", "Installing or upgrading GitLab using Helm")
    run(
